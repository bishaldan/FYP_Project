...
intents = json.loads(
    open(r'C:\Users\Mr Bishal\OneDrive\FYP_project\Chatbot\final\Student_care\member\intents.json').read())
words = pickle.load(
    open(r'C:\Users\Mr Bishal\OneDrive\FYP_project\Chatbot\final\Student_care\member\pickles\words.pkl', 'rb'))
classes = pickle.load(open(
    r'C:\Users\Mr Bishal\OneDrive\FYP_project\Chatbot\final\Student_care\member\pickles\classes.pkl', 'rb'))
